...
<body>
	<table border=0 cellSpacing=0 cellPadding=0 width="100%">
		<tr>
			<td colspan="6" align="center">销售订单</td>
		</tr>
		<tr>
			...
			<td width="15%"><span style='font-size: 13'>{$data["dealDate"]}</span></td>
		...
		<tr>
			...
			<td colspan="3"><span style='font-size: 22'>{$data["tel"]}</span></td>
		</tr>
		<tr>
			<td><span style='font-size: 13'>交货地址</span></td>
			<td colspan="5"><span style='font-size: 13'>{$data["dealAddress"]}</span></td>
		</tr>
		<tr>
			<td><span style='font-size: 13'>订单备注</span></td>
			<td colspan="5"><span style='font-size: 13'>{$data["billMemo"]}</span></td>
		</tr>
	</table>
	<br />
	<table border=1 cellSpacing=0 cellPadding=1 width="100%"
		...
		<tr>
			...
			<td><div align="center" style='font-size: 13'>销售单价</div></td>
			<td><div align="center" style='font-size: 13'>销售金额</div></td>
			<td><div align="center" style='font-size: 13'>税率</div></td>
			<td><div align="center" style='font-size: 13'>价税合计</div></td>
		</tr>
		...
		<tr>
			...
			<td><div align="right" style='font-size: 13'>{$v["taxRate"]}%</div></td>
			<td><div align="right" style='font-size: 13'>{$v["goodsMoneyWithTax"]}</div></td>
		</tr>
		</foreach>
		<tr>
			...
			<td></td>
			<td></td>
			<td><div align="right">￥{$data["goodsMoney"]}</div></td>
			<td></td>
			<td><div align="right">￥{$data["moneyWithTax"]}</div></td>
		</tr>
	</table>
</body>
</html>